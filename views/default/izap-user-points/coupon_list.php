...
// displays the info about the coupons thorough search in the admin control panel
          ...
          <td>
            ...
            if ($coupon['used'] == 'no') {
              ...
              <span id="used_<?php echo $coupons['coupon_code'] ?>">
                <a
                  href="<?php
          echo elgg_add_action_tokens_to_url(func_get_actions_path_byizap(array(
              ...
              ?>"
                  ...
                  rel="used_<?php echo $coupons['coupon_code'] ?>"><img src="<?php
              echo func_get_www_path_byizap(array(
                  'plugin' => GLOBAL_IZAP_USER_POINTS_PLUGIN,
                  'type' => 'images'
              )) . 'mark_used.gif'
              ?>"/></a></span>
