...
/**
 * saves the form for creating new coupon
 */
//validation of the forms are done here
...
$time_str = mktime(23, 59, 59, $posted_array['valid_till']['month'], $posted_array['valid_till']['day'], $posted_array['valid_till']['year']);
